            ...
            <div className="button button2" >
              <div className="polaroid"
                onClick={() => {
                  ...
                  <div class="row">
                    <div class="example-1 cardy">
                      <div class="wrapper" style={{ backgroundImage: `url(${source.urlToImage})`, backgroundPosition: "center center", backgroundSize: "cover", backgroundRepeat: "no-repeat", height: "100%" }}>
                      ...
                      <div class="data">
                        <div class="content" id={`${theme}` === 'standard' ? `stan-card` : `${theme}` === 'dark' ? `dark-card` : `${theme}` === 'green' ? `green-card` : `${theme}` === 'grey' ? `grey-card` : `${theme}` === 'red' ? `red-card` : `${theme}` === 'purple' ? `purple-card` : `${theme}` === 'indigo' ? `indigo-card` : `card`}>
                          <span class="author">{source.source.name}</span>
                          <p class="title"><b>{source.title}</b></p>
                          <p class="text">{source.description}</p>
                        </div>
                      </div>
                    </div>
                  </div>
